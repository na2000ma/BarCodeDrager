...
export class LayoutStyleConfForm implements BaseForm {
  ...
  static fields: NodeStyleFormDef = {
    width: () =>
      DefaultBuilder.input().key('width').label('width').placeholder(''),
    height: () =>
      DefaultBuilder.input().key('height').label('height').placeholder(''),
    padding: () =>
      DefaultBuilder.input().key('padding').label('padding').placeholder(''),
    margin: () =>
      DefaultBuilder.input().key('margin').label('margin').placeholder(''),
    backgroundColor: () =>
